#!/usr/bin/env python3
"""
RetinaSense v2 Extended — 50 Epoch Training Pipeline
====================================================
Fixes from v1:
...
print('='*65)
print('       RetinaSense v2 Extended — 50 Epochs Pipeline')
print('='*65)
...
plt.suptitle(f'RetinaSense v2 Extended — Macro F1={mf1:.3f} | AUC={mauc:.3f} | Val Acc={100*(all_p==all_t).mean():.1f}%',
...
print(f'\n{"="*65}')
print(f'        RETINASENSE v2 EXTENDED — FINAL RESULTS')
print(f'{"="*65}')
